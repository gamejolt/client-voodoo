...
var SelfUpdater = (function () {
    ...
    SelfUpdater.attach = function (manifestFile) {
        return __awaiter(this, void 0, void 0, function () {
            var manifestStr, manifest, controller;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.readFile(manifestFile, 'utf8')];
                    case 1:
                        manifestStr = _a.sent();
                        ...
                        controller = new controller_1.Controller(manifest.runningInfo.port, {
                            process: manifest.runningInfo.pid,
                            keepConnected: true,
                        });
                        controller.connect();
                        return [2 /*return*/, new SelfUpdaterInstance(controller)];
                }
            });
        });
    };
...
var SelfUpdaterInstance = (function (_super) {
    ...
    SelfUpdaterInstance.prototype.checkForUpdates = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
