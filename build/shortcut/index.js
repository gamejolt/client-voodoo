...
var Shortcut = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, common_1.default.fsWriteFile(desktopFile, desktopContents)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, common_1.default.chmod(desktopFile, '0755')];
                }
            });
        });
    };
    Shortcut.removeLinux = function () {
        ...
        return Promise.all([
            common_1.default.fsUnlink(desktopFile),
            common_1.default.fsUnlink(oldDesktopFile),
        ])
