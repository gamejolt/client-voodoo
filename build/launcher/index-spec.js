...
describe('Launcher', function () {
    ...
    var downloadFile = path.join('test-files', 'downloaded', 'UpSolom_Core.zip');
    ...
    var executableFile = path.join('test-files', 'patched', 'UpSolom_Core-Linux', 'UpSolom-Core.x86');
    ...
    it('Should work', function () {
        return __awaiter(_this, void 0, _promise2.default, _regenerator2.default.mark(function _callee() {
            var downloadHandle, patchHandle, launchHandle, pid;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            patchHandle = patcher_1.Patcher.patch(downloadFile, patchDir, {
                                brotli: true,
                                tempDir: tempDir,
